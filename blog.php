<?php include("inc/header.php"); ?>
			...
			<main class="container firstPara">
				...
				<ul class="blog-list">
					...
					<li><a href="blogs/5-amazing-websites.php"><h3>5 Amazing Websites</h3></a></li>
					<li><a href="blogs/pick_projects.php"><h3>How to Pick New Projects</h3></a></li>
					...
					<li><a href="blogs/hide-show-text.php"><h3>Show and Hide (Tutorial) using jQuery</h3></a></li>
					<li><a href="blogs/where-to-learn.php"><h3>Where to learn</h3></a></li>	
