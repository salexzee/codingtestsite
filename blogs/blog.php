...
<?php include(ROOT_PATH . "inc/header.php"); ?>
			...
			<main class="container firstPara">
				...
				<ul class="blog-list">
					...
					<li><a href="xampp-tut.php"><h3>Intro to XAMPP for Windows 7 (Tutorial for Beginners)</h3></a></li>
					<li><a href="custom-css-buttons.php"><h3>Custom Css Buttons (Tutorial)</h3></a></li>
					<li><a href="simple-mp-php.php"><h3>Simple Multi-Page PHP (Tutorial)</h3></a></li>
					<li><a href="hide-show-text.php"><h3>Show and Hide (Tutorial) using jQuery</h3></a></li>
					<li><a href="where-to-learn.php"><h3>Where to learn</h3></a></li>	
