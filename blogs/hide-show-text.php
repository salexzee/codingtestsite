...
<?php include("../inc/blog-header.php"); ?>
	...
	<section class="container col-xs-10 blog-posts lead">
		<h1>Show and Hide (Tutorial) <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://codingtestsite.com/blogs/hide-show-text.php" data-text="#jQuery makes showing and hiding #HTML elements a breeze. Learn how to do it." data-via="SamTheWebb" data-hashtags="blog" data-dnt="true">Tweet</a></h1>
