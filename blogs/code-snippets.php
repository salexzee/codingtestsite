...
&lt;/html&gt;
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'whycodesnippets'; // required: replace example with your forum shortname
